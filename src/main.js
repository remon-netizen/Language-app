...
import { dueNumbers } from './data/numbers-progress.js';
...
import { openReviewScreen, startPhraseReview, startNewReview, startReviewAll, getLearnedCount, getDuePhrases, getDueTotal } from './review.js';
...
function renderTodayCard() {
  ...
  const dueWords = getDueWords().length + (state.currentLanguage === 'uk' ? dueVocab().length + dueNumbers().length : 0);
