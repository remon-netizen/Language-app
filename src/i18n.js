...
const dict = {
  en: {
    ...
    'home.startSub':      'Talk with your AI tutor',
    'home.progressSub':   'Streak & what you know',
    'home.grammarTitle':  'Courses & drills',
    'home.myWords':       'My Words',
    'home.myWordsSub':    'Saved from conversations',
    ...
    'home.apiNotice':     'Add an API key in Settings for AI conversations and exercises',
    'home.apiNoticeBtn':  'Settings →',
    'home.grammarSub':    'Learn, practise & AI tools',
    'home.progress':      'Progress',
    'settings.autoPlay':  'Auto-play phrases in lessons',
    'settings.geminiFree':'Gemini (free)',
    'lesson.next':        'Next →',
    'lesson.completeTitle':'Lesson Complete!',
    'lesson.restart':     '🔄 Restart',
    'lesson.backToLessons':'← Back to lessons',
    'lesson.micNotice':   '🎙️ Microphone permission needed',
    'lesson.alphabet':    'Cyrillic Alphabet',
    'grammar.verbTitle':  '📋 Verb Lookup',
    'grammar.verbPlaceholder':'Enter a verb, e.g. писати…',
    'grammar.verbBtn':    'Look up →',
    'grammar.dissectTitle':'🔍 Sentence Dissection',
    'grammar.dissectPlaceholder':'Enter a sentence to analyse…',
    'grammar.dissectBtn': 'Analyse →',
    'chat.summaryTitle':  '📊 Summary',
  ...
  nl: {
    ...
    'home.start':         'Gesprek',
    'home.startSub':      'Praat met je AI-tutor',
    'home.progressSub':   'Reeks & wat je al kent',
    'home.grammarTitle':  'Cursussen & drills',
    'home.myWords':       'Mijn woorden',
    'home.myWordsSub':    'Opgeslagen uit gesprekken',
    'home.inburgering':   'Inburgeringsexamen',
    ...
    'home.reviewSub':     'Vandaag aan de beurt',
    ...
    'home.apiNotice':     'Voeg een API-sleutel toe bij Instellingen voor AI-gesprekken en -oefeningen',
    'home.apiNoticeBtn':  'Instellingen →',
    'home.grammarSub':    'Leren, oefenen & AI-hulp',
    'home.progress':      'Voortgang',
    'settings.autoPlay':  'Zinnen automatisch afspelen in lessen',
    'settings.geminiFree':'Gemini (gratis)',
    'lesson.next':        'Volgende →',
    'lesson.completeTitle':'Les voltooid!',
    'lesson.restart':     '🔄 Opnieuw',
    'lesson.backToLessons':'← Terug naar lessen',
    'lesson.micNotice':   '🎙️ Microfoontoegang nodig',
    'lesson.alphabet':    'Cyrillisch alfabet',
    'grammar.verbTitle':  '📋 Werkwoord opzoeken',
    'grammar.verbPlaceholder':'Typ een werkwoord, bv. писати…',
    'grammar.verbBtn':    'Opzoeken →',
    'grammar.dissectTitle':'🔍 Zin ontleden',
    'grammar.dissectPlaceholder':'Typ een zin om te ontleden…',
    'grammar.dissectBtn': 'Ontleed →',
    'chat.summaryTitle':  '📊 Samenvatting',
    'app.updateReady':    'Er is een nieuwe versie klaar',
    'app.reload':         'Herladen',
  },
};
